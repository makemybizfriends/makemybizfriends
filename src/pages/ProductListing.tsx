                ...
                <div className="flex border-2 rounded-xl border-orange-200 bg-white shadow-sm">
                  <Button 
                    ...
                    className={viewMode === 'grid' 
                      ? "rounded-l-xl bg-orange-600 hover:bg-orange-700 text-white" 
                      : "rounded-l-xl hover:bg-orange-50"
                    }
                  >
                  ...
                  <Button 
                    ...
                    className={viewMode === 'list' 
                      ? "rounded-r-xl bg-orange-600 hover:bg-orange-700 text-white" 
                      : "rounded-r-xl hover:bg-orange-50"
                    }
                  >
